...
public class CaesarCipher {
   ...
   * Preconditions: 
   *    args[0] has to be "encode" or "decode" args has to be of length 2
   * Postcondtitions: 
   *    Exits with error code 1 or 2 Calls the appropriate function and produces a
   *    list of encoded/decoded text
   */
   ...
   * Produces: 
   *    A list of text encoded with all
   *    26 permutations of the Caesar Cipher 
   * Purpose: 
   *    Encode the plaintext using Caesar Cipher
   * Preconditions:
   *    str should not be empty 
   * Postconditions: 
   *    A list of 26 encoded text should be
   ...
   *    str, a character array 
   * Produces:
   *    A list of text decoded with all
   *    26 permutations of the Caesar Cipher 
   * Purpose: 
   ...
   *    str should not be empty 
   * Postconditions: 
   *    A list of 26 decoded text should be
   *    printed to the screen
   */
